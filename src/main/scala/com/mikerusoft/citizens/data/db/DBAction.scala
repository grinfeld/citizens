...
trait DBAction[T <: Status, EvidenceRead[_], EvidenceWrite[_]] {
  ...
  def insertOfAutoIncrement[TT](db: DBAction[ConnReady, EvidenceRead, EvidenceWrite], insertStatement: String, nameAutoIncrementField: String)(implicit ev: EvidenceRead[TT]): Validation[TT]
